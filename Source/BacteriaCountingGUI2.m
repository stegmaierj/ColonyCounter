...
if (strcmp(answer, 'Yes'))
    ...
    XPIWITCommand1 = ['./XPIWIT.sh ' ...
        ...
        '--xml "../DetectionPipelineWithSegmentationEPEC2.xml" ' ...
    ...
    settings.segmentationFile = [settings.outputFolder 'item_0016_TwangSegmentation/' name '_TwangSegmentation_Out1.tif'];
